...
//	private Map<String, Cache<String, Object>> lruCache = new LinkedHashMap<String, Cache<String, Object>>(cacheSize, 0.75f, true) {
//		private static final long serialVersionUID = 1522424714036833188L;
//		@Override
//		protected boolean removeEldestEntry(Map.Entry<String, Cache<String, Object>> eldest) {
...
//	};
	...
	public <K, V> Cache<K, V> getCache(String name) throws CacheException {
		...
		zkHelper = new ZookeeperHelper(client, getZookkeeperPath());
		
		return (Cache<K, V>)new ZookeeperCache<String, Object>(zkHelper);
	}
