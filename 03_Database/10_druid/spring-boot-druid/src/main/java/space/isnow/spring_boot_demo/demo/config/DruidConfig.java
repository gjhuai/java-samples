...
import space.isnow.spring_boot_demo.demo.filter.NonQueryFilter;
...
public class DruidConfig {
    ...
    public DataSource mysqlDataSource() throws Exception{
        ...
        proxyFilters.add(nonQueryFilter());
    ...
    @Bean
    public Filter nonQueryFilter(){
    	NonQueryFilter logFilter = new NonQueryFilter();
    	return logFilter;
    }
